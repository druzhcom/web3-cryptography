...
print("\nc1,r1:", c1, ",", r1)
print("c2,r2:", c2, ",", r2)
print("\nТеперь мы можем умножить c1 и c2, что равносильно сложению Msg1 и Msg2")
print("\nОбязательство сложения (Msg1+Msg2):\t", addCM)

result1 = v.open(param, c1, msg1, r1)
result2 = v.open(param, c2, msg2, r2)

print("\nРезультат проверки c1:\t\t", result1)
print("Результат проверки c2:\t\t", result2)

result = v.open(param, addCM, msg1 + msg2, r1, r2)

print("Результат проверки Msg+Msg2:\t", result)
